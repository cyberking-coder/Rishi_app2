...
| **—** | Push notifications: live Zoom sessions in the Watch tab reminded at 60/30/5 minutes; new courses and meditations announced as they publish; a daily "start your day" audio nudge | Phase 1 | 🟡 Built, untested. Outside the numbered rollout — asked for directly. Needs migrations `20260801000007`/`8`, `FCM_SERVICE_ACCOUNT`, and both n8n cron workflows imported **and activated**. See `PROJECT_LOG.md` §7. |
